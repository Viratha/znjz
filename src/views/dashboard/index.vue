        ...
        <div class="post">
          <div class="task_all">
            ...
            <div class="task">
              ...
              <p v-if="item.statu == 0" style="color: red" class="text">已截止</p>
              <p v-if="item.statu == 1" style="color: green" class="text">未截止</p>
            </div>
          </div>
          <div class="button_task">
            ...
            <el-button
              v-if="isAdmin"
              @click="
                downloadZipFile(item.id)
              "
            >下载学员任务</el-button>
            <el-button
              v-if="!isAdmin"
              @click="task_detail_common(item.detail + ' ' + '截止时间：' + item.deadline)"
            >任务详情</el-button>
